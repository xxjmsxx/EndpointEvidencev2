  ...
  useEffect(() => {
    if (chartRef.current) {
      ...
      if (ctx) {
        ...
        // Steeper, less bell-curve-like distribution for Keytruda+Chemotherapy
        const keytrudaChemoDensity = [
          0.01, 0.02, 0.05, 0.1, 0.2, 0.4, 0.8, 1.4, 2.2, 3.2, 4.2, 5.0, 5.5, 5.7, 5.6, 5.2, 4.5, 3.6, 2.7, 1.8, 1.1,
          0.6, 0.3, 0.15, 0.05, 0.01,
        ]

        // Keytruda+Trodelvy density values - similar but with more noticeable differences
        const keytrudaTrodelvyDensity = [...keytrudaChemoDensity].map((value, index) => {
