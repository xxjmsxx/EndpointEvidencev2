...
export default function ComorbidityTypeChart() {
    ...
    if (chartRef.current) {
      ...
      if (ctx) {
        chartInstance.current = new Chart(ctx, {
          type: "bar",
          data: {
            labels: ["Hypertension", "Diabetes", "COPD", "Heart Disease"],
            datasets: [
              {
                label: "Keytruda + Trodelvy (n=260)",
                data: [38.5, 21.5, 26.0, 11.2],
                backgroundColor: "rgb(0, 102, 255)",
                barPercentage: 0.7,
                categoryPercentage: 0.8,
              },
              {
                label: "Keytruda + Chemotherapy (n=1,882)",
                data: [39.2, 23.5, 30.4, 15.3],
          ...
          options: {
            ...
            plugins: {
              ...
              title: {
                display: true,
                text: "Comorbidity Distribution by Treatment (N=2,142)",
                font: {
                  size: 18,
                  weight: "bold",
                },
